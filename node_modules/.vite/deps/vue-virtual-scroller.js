...
function Wt(e, n, i, t) {
  let s = null, d = null, g = null, w = false, v = null;
  const R = [], N = i.resizeObserver ? () => {
  } : i.onVscrollUpdate(K), p = computed(() => {
    const f = toValue(e);
  ...
  }), B = computed(() => i.vscrollData.sizes[p.value] || 0), F = computed(() => toValue(e).active && i.vscrollData.active);
  function ne() {
    F.value ? d !== p.value && (d = p.value, s = null, g = null, E(p.value)) : s = p.value;
  }
  function de() {
    toValue(e).watchData && !i.resizeObserver ? v = watch(() => toValue(e).item, () => {
      O();
    }, {
      deep: true
    }) : v && (v(), v = null);
  ...
  function le(f, z) {
    ...
    if (z) {
      i.undefinedMap[f] || i.undefinedSizeCount.value++, i.undefinedMap[f] = true;
      return;
    }
    i.undefinedMap[f] && (i.undefinedSizeCount.value--, i.undefinedMap[f] = false);
  }
  function E(f) {
    nextTick(() => {
      if (p.value === f) {
  ...
  function L(f) {
    var z, Z;
    H(p.value), i.vscrollData.sizes[p.value] = f, toValue(e).emitResize && ((Z = (z = toValue(t)) == null ? void 0 : z.onResize) == null || Z.call(z, p.value));
  }
  function b() {
    if (!i.resizeObserver || w)
      return;
    const f = toValue(n);
    f && (i.resizeObserver.observe(f), f.$_vs_id = p.value, f.$_vs_onResize = se, w = true);
  }
  function W() {
    if (!i.resizeObserver || !w)
      return;
    const f = toValue(n);
    f && (i.resizeObserver.unobserve(f), f.$_vs_onResize = void 0, w = false);
  }
  function se(f, z, Z) {
    p.value === f && ie(z, Z);
  }
  R.push(watch(() => toValue(e).watchData, () => {
    de();
  })), i.resizeObserver || R.push(watch(() => toValue(e).sizeDependencies, () => {
    O();
  }, {
    deep: true
  })), R.push(watch(p, (f, z) => {
...
function yt(e, n, i, t, s) {
  const d = ref([]), g = ref(0), w = ref(false);
  let v = 0, R = 0;
  const N = /* @__PURE__ */ new Map(), p = /* @__PURE__ */ new Map();
  let B = false, F = 0, ne = 0, de = false, K = null, O = null, H = null, le = 0, E = null, ie = [], L = null, b = null, W = null, se = false;
  const V = /* @__PURE__ */ new Set(), Y = ref({}), f = computed(() => {
    const r = toValue(e);
    ...
    const r = toValue(e), l = f.value ? null : r.keyField;
  ...
  function je(r) {
    ...
    if (l && l.length) {
      const a = l.pop();
      return a.nr.used = true, st(a), a;
    }
  }
  function Xe(r) {
    const l = r.nr.type;
    G(l).push(r), r.nr.used = false, r.position = -9999, st(r), N.delete(r.nr.key);
  }
  function Oe() {
    N.clear(), p.clear();
  ...
  function Ue() {
    var r;
    (r = s == null ? void 0 : s.onResize) == null || r.call(s), w.value && pe(false);
  }
  function ke() {
    L && !se && ee();
    const r = toValue(e);
    if (!B) {
      ...
      const l = () => We(() => {
        B = false;
        const { continuous: a } = pe(false, true);
  ...
  function c() {
    const r = toValue(n), l = r ? tt(r) : void 0;
    return window.document && (l === window.document.documentElement || l === window.document.body) ? window : l || window;
  }
  function h() {
    const r = toValue(i);
    return r ? toValue(e).direction === "vertical" ? r.scrollHeight : r.scrollWidth : 0;
  }
  function S() {
    const r = toValue(n);
    if (!r)
      return { start: 0, end: 0 };
    const l = toValue(e), a = l.direction === "vertical";
    let m;
    if (l.pageMode) {
  ...
  function M() {
    ...
    if (!r)
      return { start: 0, end: 0 };
    if (toValue(e).direction === "vertical") {
  ...
  function Se(r) {
    if (!L)
      return false;
    const l = toValue(e), a = r ?? l.items, m = f.value ? null : l.keyField, x = Ee(a, m).indexOf(L.key);
    if (x === -1)
      return ee(), false;
    const $ = h() + I(x) + L.offset, D = S().start;
    return Math.abs($ - D) < 0.5 ? false : (se = true, Ge($), We(() => {
      se = false;
    }), true);
  }
  function Ne() {
    toValue(e).pageMode ? Qt() : gt();
  }
  function Qt() {
    E = c(), E.addEventListener("scroll", ke, $n() ? { passive: true } : false), E.addEventListener("resize", Ue);
  }
  function gt() {
  ...
  function pe(r, l = false) {
    var wt, bt;
    const a = toValue(e), m = a.itemSize, y = a.gridItems || 1, x = a.itemSecondarySize || m, $ = le, D = a.typeField, re = f.value ? null : a.keyField, J = a.items, C = J.length, j = z.value, Ce = N, Fe = d.value;
  ...
  function tn() {
    throw W = setTimeout(() => {
      W = null, console.warn("It seems the scroller element isn't scrolling, so it tries to render all the items at once.", "Scroller:", toValue(n)), console.warn("Make sure the scroller has a fixed height (or width) and 'overflow-y' (or 'overflow-x') set to 'auto' so it can scroll correctly and only render the items visible in the scroll viewport.");
  ...
  function St() {
    d.value.sort((r, l) => r.nr.index - l.nr.index), nn() && (pe(false), H && clearTimeout(H));
  }
  function rn(r, l) {
    const a = toValue(e), m = toValue(n);
    if (!m)
      return;
  ...
  const Te = toValue(e);
  return ie = Ee(Te.items, Te.items.length > 0 && typeof Te.items[0] != "object" ? null : Te.keyField), Te.cache && ye(Te.cache), Te.prerender && (de = true, pe(false)), Te.gridItems && !Te.itemSize && console.error("[vue-recycle-scroller] You must provide an itemSize when using gridItems"), onMounted(() => {
    Ne(), nextTick(() => {
      de = false, pe(true), w.value = true;
    });
  }), onActivated(() => {
    const r = F;
    typeof r == "number" && nextTick(() => {
      Ge(r);
    });
  }), onBeforeUnmount(() => {
    rt(), qe(), gt();
  }), watch(() => toValue(e).cache, (r) => {
    ye(r), pe(true);
  }), watch(() => toValue(e).items, (r, l) => {
    const a = toValue(e), m = f.value ? null : a.keyField, y = Ee(r, m);
    if (a.shift) {
      const x = l ? Ee(l, m) : ie;
      Lt(x, y) > 0 ? he(l ?? [], m) : ee();
    } else
...
function xt(e) {
  return "view" in e ? {
    ...
    watchData: e.watchData ?? false,
    emitResize: e.emitResize ?? false,
...
function kn(e) {
  let n = 0, i = {};
  const t = mitt_es_default();
  let s = false, d, g = false, w = [], v = null, R = null;
  const N = /* @__PURE__ */ new Set(), p = reactive({
    active: true,
    sizes: {},
    keyField: toValue(e).keyField,
    simpleArray: false
  }), B = computed(() => toValue(e).direction), F = computed(() => toValue(toValue(e).el)), ne = computed(() => toValue(toValue(e).before)), de = computed(() => toValue(toValue(e).after)), K = /* @__PURE__ */ new Map();
  function O(o) {
    let c = -1;
  ...
  provide("vscrollData", p), provide("vscrollParent", {
    get $_undefinedSizes() {
      return n;
    },
    ...
    $_events: t,
    direction: B
  }), provide("vscrollResizeObserver", d), provide("vscrollMeasurementContext", le), provide("vscrollAnchorRegistry", {
    delete(o) {
      K.delete(o);
    },
    set(o, c) {
  ...
  const E = computed(() => {
    ...
    const o = [], c = toValue(e), { items: h, keyField: S } = c, M = E.value, _ = p.sizes, I = h.length;
  ...
  const b = computed(() => {
    ...
    return {
      ...
      typeField: "type",
      buffer: o.buffer ?? 200,
      pageMode: o.pageMode ?? false,
      shift: false,
      cache: o.cache,
      prerender: o.prerender ?? 0,
      emitUpdate: o.emitUpdate ?? false,
      updateInterval: o.updateInterval ?? 0
    };
  });
  function W() {
    var o, c;
    Oe(), (c = (o = toValue(e)).onResize) == null || c.call(o);
  }
  function se() {
    var o, c;
    t.emit("vscroll:update", { force: false }), (c = (o = toValue(e)).onVisible) == null || c.call(o);
  }
  const V = yt(
    b,
    F,
    ...
    de,
    {
      ...
      onHidden: () => {
        var o, c;
        return (c = (o = toValue(e)).onHidden) == null ? void 0 : c.call(o);
      },
      onUpdate: (o, c, h, S) => {
        var M, _;
        return (_ = (M = toValue(e)).onUpdate) == null ? void 0 : _.call(M, o, c, h, S);
      }
    }
  ...
  function G(o) {
    const c = F.value;
    return !c || Math.abs(c.scrollTop - o) < 0.5 ? false : (g = true, c.scrollTop = o, c.dispatchEvent(new Event("scroll")), O(() => {
      g = false;
    }), true);
  }
  function we() {
  ...
  function je(o, c, h, S) {
    const M = effectScope(), _ = shallowRef(c), I = shallowRef(h), ce = shallowRef({
      onResize: h.onResize
    }), ee = shallowRef(o), ve = M.run(() => (watch(() => {
      const he = _.value;
      if (!("view" in he))
        return {
  ...
  function Oe(o = false) {
    (o || E.value) && (p.sizes = {}), t.emit("vscroll:update", { force: true });
  }
  function We(o, c) {
    V.scrollToItem(o, c);
  }
  ...
  function rt(o, c) {
    const h = toValue(e), S = E.value ? c ?? h.items.indexOf(o) : o[h.keyField];
    return p.sizes[S] || 0;
  }
  function Ue() {
    const o = F.value;
    o && (s || (s = true, nextTick(() => {
      ...
      const c = () => {
        o.scrollTop = o.scrollHeight + 5e3, O(() => {
          o.scrollTop = o.scrollHeight + 5e3, n === 0 ? s = false : O(c);
        });
      };
      O(c);
    })));
  ...
  return watch(() => toValue(e).items, (o, c) => {
    const h = toValue(e), S = E.value ? null : h.keyField, M = Ee(o, S);
    if (h.shift) {
      const _ = c ? Ee(c, S) : w, I = Lt(_, M);
      I > 0 ? (ye(_), v && (v.pendingKeys = new Set(M.slice(0, I)), v.stableFrames = 0, nextTick(() => {
        v && we();
      }))) : z();
    } else
      z();
    w = M, Oe();
  }, { flush: "sync" }), watch(() => toValue(e).cache, (o) => {
    o && qe(o);
  }), watch(E, (o) => {
    p.simpleArray = o;
    ...
    const S = h.scrollTop, M = toValue(e);
    let _ = 0, I = 0;
...
function Ct(e, n) {
  ...
  if (ht.set(e, i), typeof IntersectionObserver > "u") {
    ...
    i.visible = true, i.callback(true, {
...
var Gt = defineComponent({
  ...
  setup(e) {
    const n = e;
    return (i, t) => (openBlock(), createBlock(resolveDynamicComponent(n.itemTag), { class: "vue-recycle-scroller__item-view" }, {
      default: withCtx(() => [
...
var Jt = Vn(Fn, [["__scopeId", "data-v-08cc04ab"]]);
var ft = defineComponent({
  ...
  setup(e, { expose: n, emit: i }) {
    const t = e, s = i, d = qt, g = ref(), w = ref(), v = ref(), R = ref(null), N = yt(
      t,
      g,
      w,
      v,
    ...
    return n({
      ...
      restoreCache: L,
      updateVisibleItems: b
    }), (U, ye) => withDirectives((openBlock(), createElementBlock("div", {
      ref_key: "el",
      ref: g,
      ...
      U.$slots.before ? (openBlock(), createElementBlock("div", {
        key: 0,
        ref_key: "before",
        ref: w,
      ...
      (openBlock(), createBlock(resolveDynamicComponent(t.listTag), {
        ...
        default: withCtx(() => [
          (openBlock(true), createElementBlock(Fragment, null, renderList(unref(p), (G) => (openBlock(), createBlock(Gt, mergeProps({
            key: G.nr.id,
            view: G,
            "item-tag": t.itemTag,
            style: unref(ne) ? [
            ...
            default: withCtx((we) => [
              renderSlot(U.$slots, "default", mergeProps({ ref_for: true }, we))
            ]),
            _: 2
          }, 1040, ["view", "item-tag", "style", "class"]))), 128)),
          t.items.length === 0 ? renderSlot(U.$slots, "empty", { key: 0 }) : createCommentVNode("", true)
        ]),
        _: 3
      }, 8, ["style", "class"])),
      U.$slots.after ? (openBlock(), createElementBlock("div", {
        key: 1,
        ref_key: "after",
        ref: v,
        class: "vue-recycle-scroller__slot"
      ...
      createVNode(Jt, { onNotify: unref(se) }, null, 8, ["onNotify"])
    ], 34)), [
      [unref(d), unref(V)]
    ]);
  }
...
var Ft = defineComponent({
  ...
  setup(e, { expose: n, emit: i }) {
    const t = e, s = i, d = ref(), g = computed(() => {
      var W;
    ...
    return n({
      ...
      restoreCache: O,
      forceUpdate: N
    }), (b, W) => (openBlock(), createBlock(ft, mergeProps({
      ref_key: "scroller",
      ref: d,
      items: unref(R),
      ...
      default: withCtx(({ item: se, index: V, active: Y }) => [
        renderSlot(b.$slots, "default", normalizeProps(guardReactiveProps(ie(se, V, Y))))
      ]),
      empty: withCtx(() => [
...
function An(e, n, i) {
  const t = inject("vscrollMeasurementContext"), s = inject("vscrollAnchorRegistry", null), d = Wt(
    e,
    n,
    t,
    i
...
var Vt = defineComponent({
  ...
  setup(e, { emit: n }) {
    ...
    ), (d, g) => (openBlock(), createBlock(resolveDynamicComponent(i.tag), {
      ref_key: "el",
      ref: s
    }, {
      default: withCtx(() => [
...
var At = defineComponent({
  ...
  setup(e, { expose: n, emit: i }) {
    const t = e, s = i, d = qt, g = ref(), w = ref(), v = ref(), R = En(
      t,
      g,
      w,
      v,
    ...
    return n({
      ...
      restoreCache: E,
      updateVisibleItems: ie
    }), (V, Y) => withDirectives((openBlock(), createElementBlock("div", {
      ref_key: "el",
      ref: g,
      class: normalizeClass(["vue-recycle-scroller vue-window-scroller", {
        ready: unref(B),
        [`direction-${t.direction}`]: true
      }]),
      ...
      V.$slots.before ? (openBlock(), createElementBlock("div", {
        key: 0,
        ref_key: "before",
        ref: w,
        class: "vue-recycle-scroller__slot"
      ...
      (openBlock(), createBlock(resolveDynamicComponent(t.listTag), {
        style: normalizeStyle({ [t.direction === "vertical" ? "minHeight" : "minWidth"]: `${unref(p)}px` }),
        class: normalizeClass(["vue-recycle-scroller__item-wrapper", t.listClass])
      }, {
        default: withCtx(() => [
          (openBlock(true), createElementBlock(Fragment, null, renderList(unref(N), (f) => (openBlock(), createBlock(Gt, {
            key: f.nr.id,
            view: f,
            "item-tag": t.itemTag,
            ...
            class: normalizeClass(["vue-recycle-scroller__item-view", t.itemClass])
          }, {
            default: withCtx((z) => [
              renderSlot(V.$slots, "default", mergeProps({ ref_for: true }, z))
            ]),
            _: 2
          }, 1032, ["view", "item-tag", "style", "class"]))), 128)),
          t.items.length === 0 ? renderSlot(V.$slots, "empty", { key: 0 }) : createCommentVNode("", true)
        ]),
        _: 3
      }, 8, ["style", "class"])),
      V.$slots.after ? (openBlock(), createElementBlock("div", {
        key: 1,
        ref_key: "after",
        ref: v,
        class: "vue-recycle-scroller__slot"
      ...
      createVNode(Jt, { onNotify: unref(b) }, null, 8, ["onNotify"])
    ], 34)), [
      [unref(d), unref(W)]
    ]);
  }
...
function Bn({
  ...
  }, { immediate: true }), w(), onBeforeUpdate(() => {
    w();
  }), {
    idState: i
  };
...
var Hn = {
  version: "2.0.1",
  install(e, n) {
    const i = { installComponents: true, componentsPrefix: "", ...n };
    for (const t in i)
